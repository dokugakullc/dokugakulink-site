...
export const metadata: Metadata = {
  title: "事業内容",
  description:
    "dokugaku link合同会社の事業内容。宅建・FP・行政書士・簿記などの独学支援アプリ開発と、資産家・地主・事業オーナー向けウェルスコンサルティングを展開しています。",
};
...
export default function BusinessPage() {
  return (
    <div className="bg-white">
      <div className="bg-[#0d2545] text-white">
        <div className="mx-auto max-w-6xl px-6 lg:px-8 py-20 md:py-28">
          ...
          <p className="text-blue-100 text-base mt-6 max-w-xl leading-loose">
            学習支援と意思決定支援を通じて、人生の選択肢を広げる2つの事業を展開しています。
          </p>
        </div>
      </div>

      {/* 学習プラットフォーム事業 */}
      <section id="learning" className="py-20 md:py-28 border-b border-gray-100">
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <p className="text-base font-bold text-[#0d2545]">宅地建物取引士試験 独学支援アプリ</p>
                  </div>
                  <p className="text-sm text-gray-600 leading-loose mb-5">
                    宅建試験を独学で目指す方に向けた、継続学習を支援するモバイルアプリです。
                    「忘れた頃にもう一度出題する」間隔反復の仕組みと、学習継続を後押しする体験設計で
                    独学での合格率向上を目指しています。
                  </p>
                  <ul className="space-y-2">
                    {[
                      "間隔反復アルゴリズムによる最適タイミングの復習出題",
                      "学習継続を支援するUI・UX設計",
                      "弱点分野の可視化と重点学習サポート",
      ...
      {/* ウェルスコンサルティング事業 */}
      <section id="wealth" className="py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 items-start">
            <div className="md:col-span-1">
            ...
            <div className="md:col-span-3 space-y-14">
              ...
              <div>
                ...
                <div className="bg-[#f5f7fa] border-l-4 border-[#0d2545] rounded-r-lg px-6 py-5">
