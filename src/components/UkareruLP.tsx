...
const FAQ = [
  ...
  {
    q: "利用料金はいくらですか？",
    a: "登録から30日間は、すべての機能を無料で利用できます。30日を過ぎても、今日の15問と学習履歴の閲覧は無料でそのまま続けられ、自動で課金されることはありません。より深い学習支援が必要な場合のみ、プレミアムプラン（月額580円・税込／自動更新・いつでも解約可能）に任意でご加入いただけます（正式リリース時に価格が変更となる場合があります）。",
  },
  {
    q: "どの資格に対応していますか？",
